...
const examples = [
  ...
  {
    path: "/example-3",
    title: "Example with Hydration",
    description: "This example uses client loader with hydration enabled",
    issue: "Neither loader logs on prefetch, even with hydration enabled.",
    hasClientLoader: true,
  },
];
